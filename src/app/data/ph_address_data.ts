...
export const PH_ADDRESS_DATA: Region[] = [
  ...
  },
  {
    ...
    provinces: [
      ...
      {
        name: 'Laguna',
        cities: ['Biñan City', 'Cabuyao City', 'Calamba City', 'San Pablo City', 'Santa Rosa City', 'San Pedro City'],
      },
  ...
  },
  {
    ...
    provinces: [
      ...
      },
      {
        ...
        cities: ['Dumaguete City', 'Bais City', 'Bayawan City', 'Canlaon City', 'Guihulngan City', 'Tanjay City'],
      },
