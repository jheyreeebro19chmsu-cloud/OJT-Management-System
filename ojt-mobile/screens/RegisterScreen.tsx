...
export default function RegisterScreen({ onCancel, onSuccess }: RegisterScreenProps) {
  ...
  async function handleRegister() {
    ...
    try {
      ...
      else if (role === 'admin') { profileData.department = form.department; profileData.position = 'OJT Instructor'; profileData.photo = form.photo; profileData.face_registered = !!form.photo; }
